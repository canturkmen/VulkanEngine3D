...
{
    vezero_memory(out_command_buffer, sizeof(vulkan_command_buffer));
    ...
    vkAllocateCommandBuffers(context->device.logical_device, &allocate_info, &out_command_buffer->handle);
...
void vulkan_command_buffer_submitted(vulkan_command_buffer* command_buffer)
{
