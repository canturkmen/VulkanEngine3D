    ...
    vulkan_pipeline* out_pipeline)
{
    ...
    vezero_memory(&color_blend_attachment_state, sizeof(VkPipelineColorBlendAttachmentState));
    ...
    {
        VEDEBUG("Graphics pipeline created!");
        return true;
    }

    VEERROR("vkCreateGraphicsPipelines failed with %s.", vulkan_result_string(result, true));
    return false;
}
