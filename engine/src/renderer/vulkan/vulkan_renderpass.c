    ...
    f32 stencil)
{
    ...
    color_attachment.initialLayout = VK_IMAGE_LAYOUT_UNDEFINED;     // Do not expect any particular layout before renderp pass starts. 
    ...
    depth_attachment.initialLayout = VK_IMAGE_LAYOUT_UNDEFINED;     // Do not expect any particular layout before renderp pass starts. 
    ...
    VkFramebuffer frame_buffer)
{
    ...
    vezero_memory(clear_values, sizeof(VkClearValue) * 2);
    ...
    clear_values[1].depthStencil.depth = renderpass->depht;
