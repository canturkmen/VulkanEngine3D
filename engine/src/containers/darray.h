...
u64 stride = size of each elemen in bytes.
void* elements  
*/
...
VEAPI void* _darray_create(u64 length, u64 stride);
VEAPI void _darray_destroy(void* array);

VEAPI u64 _darray_field_get(void* array, u64 field);
VEAPI void _darray_field_set(void* array, u64 field, u64 value);

VEAPI void* _darray_resize(void* array);

VEAPI void* _darray_push(void* array, const void* value_ptr);
VEAPI void _darray_pop(void* array, void* dest);

VEAPI void* _darray_pop_at(void* array, u64 index, void* dest);
VEAPI void* _darray_insert_at(void* array, u64 index, void* value_ptr);
